...
stageNames <- c("MIIOocyte_1","MIIOocyte_2","2cell_1","2cell_2","2cell_3","2cell_4","4cell_1","4cell_2","4cell_3","4cell_4","8cell_12","8cell_3","Morula_1","Morula_2","ICM_1","ICM_2","ICM_3","ICM_4")
expData_out <- c()
