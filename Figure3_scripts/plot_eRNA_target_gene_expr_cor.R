...
if (length(args) < 4) {
  stop("Usage: Rscript script_name.R <target_gene_file> <erna_file> <gene_name> <erna_name>", call. = FALSE)
}
...
ggplot(expression_matrix, aes(x = gene_expression, y = eRNA_Expression)) +
...
ggsave(paste0(gene_name, "_vs_", erna_name, "_correlation.png"), width = 8, height = 6)
###Rscript Panel3F.R /home/zmzhang/protocol/E3RC/figure2/gencode_single_stage_sample_TPM.txt /home/zmzhang/protocol/E3RC/figure2/eRNA_single_sample_TPM.txt ENSMUSG00000085180 ENH312883