...
write.table(tf.eRNA.motif.pairs,file=args[6],row.names=FALSE,col.names=FALSE,quote=FALSE)
write.csv(tf.eRNA.motif.pairs,file="/home/yjliu/E3RC/datasets/upstream_analysis_file/TF_eRNA_regulatory_network.csv",row.names=FALSE,col.names=FALSE,quote=FALSE)